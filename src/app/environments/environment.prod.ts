...
export const environment = {
  ...
  isMockEnabled: true,
  apiUrl: 'http://lyabedev.techbsl.com/api/v1',
  imageUrl: 'http://lyabedev.techbsl.com/storage/pay_slip/',
  returnUrl: 'http://lyadev.techbsl.com/payment-response',
  lastPaymentDate: '30th January 2022',
